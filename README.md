<div align="center">
  <a href="https://thisal-d.github.io/ai-verse/" target="_blank"><img src="README/main.png" alt="AI Verse" width="120"></a>
  <h1>AI Verse</h1>
  <p><strong>Your Gateway to the AI Universe</strong></p>
  <p>
    <a href="https://thisal-d.github.io/ai-verse/" target="_blank">🚀 Live Demo</a> •
...
With **128 hand-picked tools** across 14 categories, smart search, favorites, and pricing filters — it's your one-stop destination to explore the best AI has to offer.
...
│   ├── data/
│   │   ├── tools.json       # AI tools database (128 tools)
